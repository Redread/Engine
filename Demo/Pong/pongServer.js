...
leftPad.registerKeyEvent('up', function() { this.posX += 10; });
leftPad.registerKeyEvent('down', function() { this.posX -= 10; });
rightPad.registerKeyEvent('up', function() { this.posX += 10; });
rightPad.registerKeyEvent('down', function() { this.posX -= 10; });
